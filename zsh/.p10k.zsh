# Generated by Powerlevel10k configuration wizard on 2022-01-11 at 15:07 EST.
...
() {
  ...
  # To disable default icons for all segments
  ...
  typeset -g POWERLEVEL9K_FOREGROUND='black'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_BACKGROUND='blue'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='black'
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BACKGROUND='blue'
  ...
  typeset -g POWERLEVEL9K_DIR_WRITABLE_BACKGROUND='red'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREROUND='black'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='white'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND='white'
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='black'
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND='white'
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='black'
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND='white'
